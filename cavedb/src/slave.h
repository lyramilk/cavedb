...
namespace lyramilk{ namespace cave
{
	class slave
	{
	  ...
	  public:
		...
		virtual bool notify_command(const lyramilk::data::string& masterid,const lyramilk::data::string& replid,lyramilk::data::uint64 offset,lyramilk::data::array& args,void* userdata) = 0;
