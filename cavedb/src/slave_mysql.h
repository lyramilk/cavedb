...
{
	class slave_mysql:public lyramilk::threading::threads
	{
	  ...
	  public:
		slave_mysql();
		virtual ~slave_mysql();
		void slaveof(const lyramilk::data::string& host,lyramilk::data::uint16 port,const lyramilk::data::string& user,const lyramilk::data::string& pwd,lyramilk::data::string psync_replid,lyramilk::data::uint64 psync_offset,slave* peventhandler);
